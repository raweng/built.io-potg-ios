...
/**
 ...
 @discussion Executes a single or a chained query and callbacks the QueryResult.
 @param successBlock CallBack in case of success.
 @param errorBlock CallBack in case of failure.
 
 */
- (void)exec:(void (^) (QueryResult *result))successBlock onError:(void (^) (NSError *error))errorBlock;
