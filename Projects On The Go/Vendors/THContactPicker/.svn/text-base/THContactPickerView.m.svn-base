...
//        [self.delegate contactPickerDidRemoveContact:[contact nonretainedObjectValue]];//akshay
        [self.delegate contactPickerDidRemoveContact:contact];//akshay
    }*/
    if ([self.delegate respondsToSelector:@selector(contactPickerDidRemoveContact:forPicker:)]){//akshay
        [self.delegate contactPickerDidRemoveContact:contact forPicker:self];//akshay
    }
